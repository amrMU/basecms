...
<fieldset class="content-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <input type="text" name="title[]" class="form-control" placeholder="@lang('home.title_'.@$lang->info->local)" value="">
        </div>
    </div>
    <!-- /title ar input -->
    <!-- title ar input -->
    <div class="form-group">
        <label class="control-label col-lg-3">@lang('home.address_'.@$lang->info->local) <span class="text-danger" title="@lang('home.required')">*</span></label>
        <div class="col-lg-9">
            <input type="text" name="address[]" class="form-control" placeholder="@lang('home.address_'.@$lang->info->local)" value="">
        </div>
    </div>
    <!-- /title ar input -->
      {{-- content ar --}}
     <div class="form-group">
        ...
        <div class="col-lg-9">
             <textarea name="content[]" id="editor1" rows="4" cols="4"  placeholder="@lang('home.content_'.@$lang->info->local)"></textarea>
        </div>
    </div>
