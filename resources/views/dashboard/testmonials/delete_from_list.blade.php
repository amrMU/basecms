...
<button type="button" class="btn btn-danger " data-toggle="modal" data-target="#DeleteFromList{{@$testmonial->id}}">
<li class="icon-trash"></li>
</button>


<!-- Modal -->
<div id="DeleteFromList{{@$testmonial->id}}" class="modal fade" role="dialog">
