                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <input type="hidden" name="title_lang[]" value="<?php echo e(@$lang->id); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
                                 ...
                                 <!-- content ar input -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <input type="hidden" name="content_lang[]" value="<?php echo e(@$lang->id); ?>">
                                ...
                                <fieldset class="content-group">
                                    <legend class="text-bold"><?php echo app('translator')->getFromJson('home.smtp_builder'); ?></legend>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" name="mail_username" class="form-control" placeholder="info@example.com" value="<?php echo e(@$info->mail_provider_info->MAIL_USERNAME); ?>" >
                                            </div>
                                        </div>
                                        <!-- /mail_user_name field -->
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="wrap_social_media">
                                        ...
                                        <div class="form-group" >
                                           ...
                                           <div class="col-lg-2">
                                              <img src="<?php echo e(url('/').@$link->icon); ?>" class="img-responsive" style="max-height: 46px" >
                                            </div>
                                            <div class="col-lg-4">
