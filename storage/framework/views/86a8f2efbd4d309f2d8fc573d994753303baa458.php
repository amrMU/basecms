                ...
                <!-- Form validation -->
                    <div class="panel panel-flat col-md-10">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal form-validate-jquery" method="post" action="<?php echo e(route('users.update',$info)); ?>" enctype='multipart/form-data'  >
                            ...
                            <input name="use" type="hidden" value="<?php echo e(@$info->id); ?>">
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="fname" class="form-control" placeholder="<?php echo app('translator')->getFromJson('home.fname'); ?>" value="<?php echo e(@$info->fname); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="lname" class="form-control"  placeholder="<?php echo app('translator')->getFromJson('home.lname'); ?>" value="<?php echo e(@$info->lname); ?>">
                                        </div>
                                    </div>
                                    <!-- /title ar input -->
                                 ...
                                 <!-- content ar input -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea name="email" class="form-control"  placeholder="<?php echo app('translator')->getFromJson('home.email'); ?>"><?php echo e(@$info->email); ?></textarea>
                                        </div>
                                    </div>
                                    <!-- /content ar input -->
                                    <!-- content en input -->
                                        ...
                                        <select name="city_id" class="form-control">
                                            <option value="null"><?php echo app('translator')->getFromJson('home.address'); ?></option>
                                                <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(@$city->id); ?>" <?php if($info->city_id == $city->id): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e((App::isLocale('en')  ? @$city->nameEn : @$city->nameAr)); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="phone" class="form-control" placeholder="<?php echo app('translator')->getFromJson('home.phone'); ?>" value="<?php echo e(@$info->phone); ?>">
                                        </div>
                                    </div>
                                    <!-- /Meta Tags input -->
                                    <!-- password input -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <input type="text" class="form-control" name="password" placeholder="<?php echo app('translator')->getFromJson('home.password'); ?>" id="input_password"  autocomplete="off">
