...
<?php if($category->testmonials->count() > 0): ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="clients-slider wow fadeInUp">
                    <?php $__currentLoopData = $category->testmonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test_monial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="item">
                        <div class="info">
                            <div class="img">
