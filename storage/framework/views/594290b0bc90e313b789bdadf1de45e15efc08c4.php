...
<button type="button" class="btn btn-danger " data-toggle="modal" data-target="#DeleteFromList<?php echo e(@$testmonial->id); ?>">
<li class="icon-trash"></li>
</button>


<!-- Modal -->
<div id="DeleteFromList<?php echo e(@$testmonial->id); ?>" class="modal fade" role="dialog">
